...
public class LocationsTracking {
    private static final String TABLE_NAME = "CONTACTED_LOCATIONS";
    private static final String KEY_ID = "id";
    private static final String KEY_QR_CODE_HASH = "qr_code_hash";
    ...
    public static String getKeyQrCodeHash() {
        return KEY_QR_CODE_HASH;
    }
